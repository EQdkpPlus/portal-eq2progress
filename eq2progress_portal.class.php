 ...
 * This will be the final update from me, I will be leaving the project.
 * Feel free to continue, modify, update, as you see fit.  Safe Journeys!
 * V7.0 Added Ballads of Zimara
 * V6.73 Added Contested
 * V6.72 Added The Sultan's
 * V6.71 Added Renewal of Ro
 * V6.70 Added Fabled Veeshans Peak
 * v6.67 Minor Fix
 * v6.66 Added Coffers & Coffins
 * v6.65 Added Visions of Vetrovia
 * v6.64 Added Vex Thal Challenge Mode
 * v6.63 Minor Fix
 * v6.62 Added Whispers of Tyrrany Raids
 * V6.61 Minor Fix
...
class eq2progress_portal extends portal_generic {
    ...
    public function get_settings($state) {
        $settings = array(
            ...
            'eq2progress_ros5'  => array(
                'name'      => 'eq2progress_ros5',
                'language'  => 'eq2progress_ros5',
                'type'  => 'radio',
            ),
            'eq2progress_ros6'  => array(
                'name'      => 'eq2progress_ros6',
                'language'  => 'eq2progress_ros6',
                'type'  => 'radio',
            ),
            'eq2progress_ros7'  => array(
                'name'      => 'eq2progress_ros7',
                'language'  => 'eq2progress_ros7',
                'type'  => 'radio',
            ),
			'eq2progress_vov1'  => array(
                'name'      => 'eq2progress_vov1',
                'language'  => 'eq2progress_vov1',
                'type'  => 'radio',
            ),
			'eq2progress_vov2'  => array(
                'name'      => 'eq2progress_vov2',
                'language'  => 'eq2progress_vov2',
                'type'  => 'radio',
            ),
			'eq2progress_vov3'  => array(
                'name'      => 'eq2progress_vov3',
                'language'  => 'eq2progress_vov3',
                'type'  => 'radio',
            ),
			'eq2progress_vov4'  => array(
                'name'      => 'eq2progress_vov4',
                'language'  => 'eq2progress_vov4',
                'type'  => 'radio',
            ),
			'eq2progress_vov5'  => array(
                'name'      => 'eq2progress_vov5',
                'language'  => 'eq2progress_vov5',
                'type'  => 'radio',
            ),
            'eq2progress_vov6'  => array(
                'name'      => 'eq2progress_vov6',
                'language'  => 'eq2progress_vov6',
                'type'  => 'radio',
            ),
            'eq2progress_fvp'  => array(
                'name'      => 'eq2progress_fvp',
                'language'  => 'eq2progress_fvp',
                'type'  => 'radio',
            ),
            'eq2progress_fkt'  => array(
                'name'      => 'eq2progress_fkt',
                'language'  => 'eq2progress_fkt',
                'type'  => 'radio',
            ),
			'eq2progress_fktg'  => array(
                'name'      => 'eq2progress_fktg',
                'language'  => 'eq2progress_fktg',
                'type'  => 'radio',
			),
			'eq2progress_ror1'  => array(
                'name'      => 'eq2progress_ror1',
                'language'  => 'eq2progress_ror1',
                'type'  => 'radio',
			),
			'eq2progress_ror2'  => array(
                'name'      => 'eq2progress_ror2',
                'language'  => 'eq2progress_ror2',
                'type'  => 'radio',
			),
			'eq2progress_ror3'  => array(
                'name'      => 'eq2progress_ror3',
                'language'  => 'eq2progress_ror3',
                'type'  => 'radio',
			),
			'eq2progress_ror4'  => array(
                'name'      => 'eq2progress_ror4',
                'language'  => 'eq2progress_ror4',
                'type'  => 'radio',
			),
			'eq2progress_ror5'  => array(
                'name'      => 'eq2progress_ror5',
                'language'  => 'eq2progress_ror5',
                'type'  => 'radio',
			),
			'eq2progress_ror6'  => array(
                'name'      => 'eq2progress_ror6',
                'language'  => 'eq2progress_ror6',
                'type'  => 'radio',
			),
			'eq2progress_boz1'  => array(
                'name'      => 'eq2progress_boz1',
                'language'  => 'eq2progress_boz1',
                'type'  => 'radio',
			),
			'eq2progress_boz2'  => array(
                'name'      => 'eq2progress_boz2',
                'language'  => 'eq2progress_boz2',
                'type'  => 'radio',
			),
			'eq2progress_boz3'  => array(
                'name'      => 'eq2progress_boz3',
                'language'  => 'eq2progress_boz3',
                'type'  => 'radio',
			),
			'eq2progress_boz4'  => array(
                'name'      => 'eq2progress_boz4',
                'language'  => 'eq2progress_boz4',
                'type'  => 'radio',
			),
    ...
    public function output() {
        ...
        if (($this->config('eq2progress_ros5')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone78 = TRUE); }
        if (($this->config('eq2progress_ros6')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone79 = TRUE); }
        if (($this->config('eq2progress_ros7')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone80 = TRUE); }
        if (($this->config('eq2progress_vov1')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone81 = TRUE); }
        if (($this->config('eq2progress_vov2')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone82 = TRUE); }
        if (($this->config('eq2progress_vov3')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone83 = TRUE); }
        if (($this->config('eq2progress_vov4')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone84 = TRUE); }
        if (($this->config('eq2progress_vov5')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone85 = TRUE); }
        if (($this->config('eq2progress_vov6')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone86 = TRUE); }
        if (($this->config('eq2progress_fvp')) == TRUE )            { ($maxbars = $maxbars + 1); ($zone87 = TRUE); }
        if (($this->config('eq2progress_fkt')) == TRUE )            { ($maxbars = $maxbars + 1); ($zone88 = TRUE); }
        if (($this->config('eq2progress_fktg')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone89 = TRUE); }
	if (($this->config('eq2progress_ror1')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone90 = TRUE); }
	if (($this->config('eq2progress_ror2')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone91 = TRUE); }
	if (($this->config('eq2progress_ror3')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone92 = TRUE); }
	if (($this->config('eq2progress_ror4')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone93 = TRUE); }
	if (($this->config('eq2progress_ror5')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone94 = TRUE); }
	if (($this->config('eq2progress_ror6')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone95 = TRUE); }
	if (($this->config('eq2progress_boz1')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone96 = TRUE); }
	if (($this->config('eq2progress_boz2')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone97 = TRUE); }
	if (($this->config('eq2progress_boz3')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone98 = TRUE); }
	if (($this->config('eq2progress_boz4')) == TRUE )           { ($maxbars = $maxbars + 1); ($zone99 = TRUE); }
	$arena = 0; $contested = 0; $harrows = 0; $sleeper = 0; $altar = 0; $pow = 0; $dread = 0; $sirens = 0; $djinn= 0;
        ...
        $ros1 = 0; $ros2 = 0; $ros3 = 0; $ros4 = 0; $ros5 = 0; $ros6 = 0; $ros7 = 0; $vov1 = 0; $vov2 = 0; $vov3 = 0; $vov4 = 0; $vov5 = 0; 
        $vov6 = 0; $fvp = 0; $fkt = 0; $fktg = 0; $ror1 = 0; $ror2 = 0; $ror3 = 0; $ror4 = 0; $ror5 = 0; $ror6 = 0;
	$boz1 = 0; $boz2 = 0; $boz3 = 0; $boz4 = 0; 
        ...
        $ros5max = 6; $ros6max = 4; $ros6max = 4; $ros7max = 6; $vov1max =5; $vov2max =5; $vov3max =5; $vov4max =5; $vov5max =5; 
        $vov6max = 7; $fvpmax = 13; $fktmax = 5; $fktgmax = 5; $ror1max = 6; $ror2max = 6; $ror3max = 6; $ror4max = 8; $ror5max = 1; $ror6max = 1; 
	$boz1max = 3; $boz2max = 3; $boz3max = 5; $boz4max = 5; 
        ...
        $ros5val=$this->user->lang('eq2progress_f_eq2progress_ros5');
        $ros51=$spacer.'<font color="white">Emperor Ssraeshza</font><br>'; 
        $ros52=$spacer.'<font color="white">High Priest Verrkar</font><br>'; 
        $ros53=$spacer.'<font color="white">Akhessa Va Liako Vess</font><br>'; 
        $ros54=$spacer.'<font color="white">Thall Va Xakra Fer</font><br>'; 
        $ros55=$spacer.'<font color="white">Thall Xundrax Diabo</font><br>'; 
        $ros56=$spacer.'<font color="white">Diabo Xi Va</font><br>'; 
        $ros6val=$this->user->lang('eq2progress_f_eq2progress_ros6');
        $ros61=$spacer.'<font color="white">Colossus of Crystallized Shadow</font><br>'; 
        $ros62=$spacer.'<font color="white">Shadowcaster Grimlock</font><br>'; 
        $ros63=$spacer.'<font color="white">Beast From Beyond</font><br>'; 
        $ros64=$spacer.'<font color="white">Greta Gnitrat</font><br>'; 
        $ros7val=$this->user->lang('eq2progress_f_eq2progress_ros7');
        $ros71=$spacer.'<font color="white">Emperor Ssraeshza</font><br>'; 
        $ros72=$spacer.'<font color="white">High Priest Verrkar</font><br>'; 
        $ros73=$spacer.'<font color="white">Akhessa Va Liako Vess</font><br>'; 
        $ros74=$spacer.'<font color="white">Thall Va Xakra Fer</font><br>'; 
        $ros75=$spacer.'<font color="white">Thall Xundrax Diabo</font><br>'; 
        $ros76=$spacer.'<font color="white">Diabo Xi Va</font><br>'; 
        $vov1val=$this->user->lang('eq2progress_f_eq2progress_vov1');
        $vov11=$spacer.'<font color="white">Guardian of the Pulmage</font><br>'; 
        $vov12=$spacer.'<font color="white">Behemothrus and Gargantaur</font><br>'; 
        $vov13=$spacer.'<font color="white">Vetrovian Mantrap</font><br>'; 
        $vov14=$spacer.'<font color="white">Glaur Xrzin</font><br>'; 
        $vov15=$spacer.'<font color="white">Quilliclaw</font><br>';
        $vov2val=$this->user->lang('eq2progress_f_eq2progress_vov2');
        $vov21=$spacer.'<font color="white">Ritual Lords</font><br>'; 
        $vov22=$spacer.'<font color="white">Cewtie Irewater</font><br>'; 
        $vov23=$spacer.'<font color="white">Persepherator</font><br>'; 
        $vov24=$spacer.'<font color="white">Cliff Dweller Gadsin</font><br>'; 
        $vov25=$spacer.'<font color="white">Cewtie Irewater</font><br>'; 
        $vov3val=$this->user->lang('eq2progress_f_eq2progress_vov3');
        $vov31=$spacer.'<font color="white">Lithania Dyrmelia</font><br>'; 
        $vov32=$spacer.'<font color="white">Reanimated Horror</font><br>'; 
        $vov33=$spacer.'<font color="white">Hand of Lithania</font><br>'; 
        $vov34=$spacer.'<font color="white">G\'dalt Spirit-stitcher</font><br>'; 
        $vov35=$spacer.'<font color="white">Envoy to Bloodrite</font><br>'; 
        $vov4val=$this->user->lang('eq2progress_f_eq2progress_vov4');
        $vov41=$spacer.'<font color="white">Vorigan Mistmoore</font><br>'; 
        $vov42=$spacer.'<font color="white">Lysander Mistmoore</font><br>'; 
        $vov43=$spacer.'<font color="white">Bloodtender and Gidget</font><br>'; 
        $vov44=$spacer.'<font color="white">Legion Captain Bloodrite</font><br>'; 
        $vov45=$spacer.'<font color="white">Lady of the Lute</font><br>'; 
        $vov5val=$this->user->lang('eq2progress_f_eq2progress_vov5');
        $vov51=$spacer.'<font color="white">Lord Mayong Mistmoore</font><br>'; 
        $vov52=$spacer.'<font color="white">Poppet the Thrasher</font><br>'; 
        $vov53=$spacer.'<font color="white">Lenya Thex</font><br>'; 
        $vov54=$spacer.'<font color="white">Zarrakon Resurrected</font><br>'; 
        $vov55=$spacer.'<font color="white">Butcher</font><br>'; 
        $vov6val=$this->user->lang('eq2progress_f_eq2progress_vov6');
        $vov61=$spacer.'<font color="white">Grandmother Deliria</font><br>'; 
        $vov62=$spacer.'<font color="white">Mother Ballentree</font><br>'; 
        $vov63=$spacer.'<font color="white">Cloaked Necromancer</font><br>'; 
        $vov64=$spacer.'<font color="white">Sister Belladonna & Auntie Grimm</font><br>'; 
        $vov65=$spacer.'<font color="white">Odelia Wretch</font><br>'; 
        $vov66=$spacer.'<font color="white">Beulus the claw</font><br>'; 
        $vov67=$spacer.'<font color="white">Flora Meldahyde</font><br>'; 
        $fvpval=$this->user->lang('eq2progress_f_eq2progress_fvp');
        $fvp1=$spacer.'<font color="white">Trakanon</font><br>'; 
        $fvp2=$spacer.'<font color="white">Phara Dar</font><br>'; 
        $fvp3=$spacer.'<font color="white">Silverwing</font><br>'; 
        $fvp4=$spacer.'<font color="white">Travenro the Skygazer</font><br>';
        $fvp5=$spacer.'<font color="white">Xygoz</font><br>'; 
        $fvp6=$spacer.'<font color="white">Hoshkar</font><br>'; 
        $fvp7=$spacer.'<font color="white">Qunard Ashenclaw</font><br>'; 
        $fvp8=$spacer.'<font color="white">Milyex Vioren</font><br>'; 
        $fvp9=$spacer.'<font color="white">Taskmaster Nichok</font><br>'; 
        $fvp10=$spacer.'<font color="white">Druushk</font><br>'; 
        $fvp11=$spacer.'<font color="white">Elder Ekron</font><br>'; 
        $fvp12=$spacer.'<font color="white">Nexona</font><br>'; 
        $fvp13=$spacer.'<font color="white">Kluzen the Protector</font><br>'; 
        $fktval=$this->user->lang('eq2progress_f_eq2progress_fkt');
        $fkt1=$spacer.'<font color="white">Warlord Kurn Machta</font><br>'; 
        $fkt2=$spacer.'<font color="white">Sir Rouland</font><br>'; 
        $fkt3=$spacer.'<font color="white">Ione the Lifebringer</font><br>'; 
        $fkt4=$spacer.'<font color="white">Ilenee\'s Betrayal and Despair</font><br>'; 
        $fkt5=$spacer.'<font color="white">Haggle Baron Klok</font><br>'; 
        $fktgval=$this->user->lang('eq2progress_f_eq2progress_fktg');
        $fktg1=$spacer.'<font color="white">Warlord Kurn Machta</font><br>'; 
        $fktg2=$spacer.'<font color="white">Sir Rouland</font><br>'; 
        $fktg3=$spacer.'<font color="white">Ione the Lifebringer</font><br>'; 
        $fktg4=$spacer.'<font color="white">Ilenee\'s Betrayal and Despair</font><br>'; 
        $fktg5=$spacer.'<font color="white">Haggle Baron Klok</font><br>'; 
	$ror1val=$this->user->lang('eq2progress_f_eq2progress_ror1');
	$ror11=$spacer.'<font color="white">Raj\'Dur Foreman Yato</font><br>'; $ror12=$spacer.'<font color="white">Raj\'Dur Leader Mamu</font><br>'; 
	$ror13=$spacer.'<font color="white">Avenging Desert Spirit</font><br>'; $ror14=$spacer.'<font color="white">Poacher Paol</font><br>'; 
	$ror15=$spacer.'<font color="white">Sythe Rotgut</font><br>'; $ror16=$spacer.'<font color="white">Slither Rattlebones</font><br>'; 
	$ror2val=$this->user->lang('eq2progress_f_eq2progress_ror2');
	$ror21=$spacer.'<font color="white">Embodiment of Fright</font><br>'; $ror22=$spacer.'<font color="white">Tsmang Blightswarm Broodmaster</font><br>'; 
	$ror23=$spacer.'<font color="white">Malformed Prophet</font><br>'; $ror24=$spacer.'<font color="white">Lockmaw</font><br>'; 
	$ror25=$spacer.'<font color="white">Mad Zealot</font><br>'; $ror26=$spacer.'<font color="white">Rath\'Mana High Priest</font><br>'; 
	$ror3val=$this->user->lang('eq2progress_f_eq2progress_ror3');
	$ror31=$spacer.'<font color="white">Huhmuhngus Fuhngus Amuhngus</font><br>'; $ror32=$spacer.'<font color="white">Desert Wildcat Matron</font><br>'; 
	$ror33=$spacer.'<font color="white">Myht-moo Migmu</font><br>'; $ror34=$spacer.'<font color="white">Jellyfisher Ancient</font><br>'; 
	$ror35=$spacer.'<font color="white">Ragtag the Despoiler</font><br>'; $ror36=$spacer.'<font color="white">Nirag the Boundless</font><br>'; 
	$ror4val=$this->user->lang('eq2progress_f_eq2progress_ror4');
	$ror41=$spacer.'<font color="white">Stonesong</font><br>'; $ror42=$spacer.'<font color="white">Rugrat</font><br>'; 
	$ror43=$spacer.'<font color="white">Monument of Stone</font><br>'; $ror44=$spacer.'<font color="white">Them Bones</font><br>'; 
	$ror45=$spacer.'<font color="white">Veagth</font><br>'; $ror46=$spacer.'<font color="white">Uruk the Unbound</font><br>'; 
	$ror47=$spacer.'<font color="white">Terrene Tyrant</font><br>'; $ror48=$spacer.'<font color="white">Sanum Ordast</font><br>'; 
	$ror5val=$this->user->lang('eq2progress_f_eq2progress_ror5');
	$ror51=$spacer.'<font color="white">Aldys</font><br>'; 
	$ror6val=$this->user->lang('eq2progress_f_eq2progress_ror6');
	$ror61=$spacer.'<font color="white">Titanious</font><br>';
	$boz1val=$this->user->lang('eq2progress_f_eq2progress_boz1');
	$boz11=$spacer.'<font color="white">Aurous the Judged</font><br>'; $boz12=$spacer.'<font color="white">Krayte, Titan of Colors</font><br>';
	$boz13=$spacer.'<font color="white">Chromon</font><br>';
	$boz2val=$this->user->lang('eq2progress_f_eq2progress_boz2');
	$boz21=$spacer.'<font color="white">Chohnkanon</font><br>'; $boz22=$spacer.'<font color="white">Chohnkasaurus</font><br>';
	$boz23=$spacer.'<font color="white">Chohnki</font><br>';
	$boz3val=$this->user->lang('eq2progress_f_eq2progress_boz3');
	$boz31=$spacer.'<font color="white">Rouk the Immeasurable</font><br>'; $boz32=$spacer.'<font color="white">Rouk the Ironclad</font><br>';
	$boz33=$spacer.'<font color="white">Rouk the Lustrous</font><br>'; $boz34=$spacer.'<font color="white">Tuer\'el of the Delves</font><br>';
	$boz35=$spacer.'<font color="white">Mezkhuur, Equestrian Liege</font><br>';
	$boz4val=$this->user->lang('eq2progress_f_eq2progress_boz4');
	$boz41=$spacer.'<font color="white">Zakir-Sar-Ussur</font><br>'; $boz42=$spacer.'<font color="white">St\'Vyrn the Persecutor</font><br>';
	$boz42=$spacer.'<font color="white">Ikal-tam the Pensive</font><br>'; $boz44=$spacer.'<font color="white">Chaltieu, Mirrored Sentry</font><br>';
	$boz45=$spacer.'<font color="white">Galeistria the Polished</font><br>';
	//Check which have been killed
        ...
        //Shadeweaver's Thicket: Spirit Harvest
        if ($acid == '645819211')  {$ros5 = $ros5 + 1; $ros51 =$kdate.'<font color="808080"><strike>Emperor Ssraeshza</strike></font><br>';} 
        if ($acid == '3536706852') {$ros5 = $ros5 + 1; $ros52 =$kdate.'<font color="808080"><strike>High Priest Verrkar</strike></font><br>';} 
        if ($acid == '3285086321') {$ros5 = $ros5 + 1; $ros53 =$kdate.'<font color="808080"><strike>Akhessa Va Liako Vess</strike></font><br>';} 
        if ($acid == '1339226413') {$ros5 = $ros5 + 1; $ros54 =$kdate.'<font color="808080"><strike>Thall Va Xakra Fer</strike></font><br>';} 
        if ($acid == '4106858591') {$ros5 = $ros5 + 1; $ros55 =$kdate.'<font color="808080"><strike>Thall Xundrax Diabo</strike></font><br>';} 
        if ($acid == '523360772')  {$ros5 = $ros5 + 1; $ros56 =$kdate.'<font color="808080"><strike>Diabo Xi Va</strike></font><br>';} 
        //Savage Weald: Shadow's Hold [Raid]
        if ($acid == '3843799499') {$ros6 = $ros6 + 1; $ros61 =$kdate.'<font color="808080"><strike>Colossus of Crystallized Shadow</strike></font><br>';} 
        if ($acid == '145424089')  {$ros6 = $ros6 + 1; $ros62 =$kdate.'<font color="808080"><strike>Shadowcaster Grimlock</strike></font><br>';}
        if ($acid == '3567735299') {$ros6 = $ros6 + 1; $ros63 =$kdate.'<font color="808080"><strike>Beast From Beyond</strike></font><br>';} 
        if ($acid == '2825024321') {$ros6 = $ros6 + 1; $ros64 =$kdate.'<font color="808080"><strike>Greta Gnitrat</strike></font><br>';}
        //Challenge Vex Thall
        if ($acid == '1770468018') {$ros7 = $ros7 + 1; $ros71 =$kdate.'<font color="808080"><strike>Emperor Ssraeshza</strike></font><br>';} 
        if ($acid == '84156793')   {$ros7 = $ros7 + 1; $ros72 =$kdate.'<font color="808080"><strike>High Priest Verrkar</strike></font><br>';} 
        if ($acid == '132170640')  {$ros7 = $ros7 + 1; $ros73 =$kdate.'<font color="808080"><strike>Akhessa Va Liako Vess</strike></font><br>';} 
        if ($acid == '2348567244') {$ros7 = $ros7 + 1; $ros74 =$kdate.'<font color="808080"><strike>Thall Va Xakra Fer</strike></font><br>';} 
        if ($acid == '587222018')  {$ros7 = $ros7 + 1; $ros75 =$kdate.'<font color="808080"><strike>Thall Xundrax Diabo</strike></font><br>';} 
        if ($acid == '2181947052') {$ros7 = $ros7 + 1; $ros76 =$kdate.'<font color="808080"><strike>Diabo Xi Va</strike></font><br>';} 
        //Karuupa Jungle: The Fading Light
        if ($acid == '2941030405') {$vov1 = $vov1 + 1; $vov11 =$kdate.'<font color="808080"><strike>Guardian of the Pulmage</strike></font><br>';}
        if ($acid == '2652917887') {$vov1 = $vov1 + 1; $vov12 =$kdate.'<font color="808080"><strike>Behemothrus and Gargantaur</strike></font><br>';}
        if ($acid == '2393537244') {$vov1 = $vov1 + 1; $vov13 =$kdate.'<font color="808080"><strike>Vetrovian Mantrap</strike></font><br>';}
        if ($acid == '3105598883') {$vov1 = $vov1 + 1; $vov14 =$kdate.'<font color="808080"><strike>Glaur Xrzin</strike></font><br>';}
        if ($acid == '4211736748') {$vov1 = $vov1 + 1; $vov15 =$kdate.'<font color="808080"><strike>Quilliclaw</strike></font><br>';}
        //Mahngavi Wastes: The Engulfing Light
        if ($acid == '3277180147') {$vov2 = $vov2 + 1; $vov21 =$kdate.'<font color="808080"><strike>Ritual Lords</strike></font><br>';}
        if ($acid == '1834330541') {$vov2 = $vov2 + 1; $vov22 =$kdate.'<font color="808080"><strike>Cewtie Irewater</strike></font><br>';}
        if ($acid == '2979000600') {$vov2 = $vov2 + 1; $vov23 =$kdate.'<font color="808080"><strike>Persepherator</strike></font><br>';}
        if ($acid == '944553121')  {$vov2 = $vov2 + 1; $vov24 =$kdate.'<font color="808080"><strike>Cliff Dweller Gadsin</strike></font><br>';}
        if ($acid == '1588436326') {$vov2 = $vov2 + 1; $vov25 =$kdate.'<font color="808080"><strike>Cewtie Irewater</strike></font><br>';}
        //Forlorn Gist: Emerging Deceit
        if ($acid == '3302308128') {$vov3 = $vov3 + 1; $vov31 =$kdate.'<font color="808080"><strike>Lithania Dyrmelia</strike></font><br>';}
        if ($acid == '3251294575') {$vov3 = $vov3 + 1; $vov32 =$kdate.'<font color="808080"><strike>Reanimated Horror</strike></font><br>';}
        if ($acid == '2781168967') {$vov3 = $vov3 + 1; $vov33 =$kdate.'<font color="808080"><strike>Hand of Lithania</strike></font><br>';}
        if ($acid == '3708610435') {$vov3 = $vov3 + 1; $vov34 =$kdate.'<font color="808080"><strike>G\'dalt Spirit-stitcher</strike></font><br>';}
        if ($acid == '3747529781') {$vov3 = $vov3 + 1; $vov35 =$kdate.'<font color="808080"><strike>Envoy to Bloodrite</strike></font><br>';}		
        //Castle Vacrul: Thirst for Powered
        if ($acid == '3211392311') {$vov4 = $vov4 + 1; $vov41 =$kdate.'<font color="808080"><strike>Vorigan Mistmoore</strike></font><br>';}
        if ($acid == '273940577')  {$vov4 = $vov4 + 1; $vov42 =$kdate.'<font color="808080"><strike>Lysander Mistmoore</strike></font><br>';}
        if ($acid == '3501959631') {$vov4 = $vov4 + 1; $vov43 =$kdate.'<font color="808080"><strike>Bloodtender and Gidget</strike></font><br>';}
        if ($acid == '4275391114') {$vov4 = $vov4 + 1; $vov44 =$kdate.'<font color="808080"><strike>Legion Captain Bloodrite</strike></font><br>';}
        if ($acid == '2229859640') {$vov4 = $vov4 + 1; $vov45 =$kdate.'<font color="808080"><strike>Lady of the Lute</strike></font><br>';}
        //Castle Vacrul: Haunting Presence
        if ($acid == '2415583410') {$vov5 = $vov5 + 1; $vov51 =$kdate.'<font color="808080"><strike>Lord Mayong Mistmoore</strike></font><br>';}
        if ($acid == '588416013')  {$vov5 = $vov5 + 1; $vov52 =$kdate.'<font color="808080"><strike>Poppet the Thrasher</strike></font><br>';}
        if ($acid == '1049981831') {$vov5 = $vov5 + 1; $vov53 =$kdate.'<font color="808080"><strike>Lenya Thex</strike></font><br>';}
        if ($acid == '805677912')  {$vov5 = $vov5 + 1; $vov54 =$kdate.'<font color="808080"><strike>Zarrakon Resurrected</strike></font><br>';}
        if ($acid == '2020327428') {$vov5 = $vov5 + 1; $vov55 =$kdate.'<font color="808080"><strike>Butcher</strike></font><br>';}
        //Forlorn Gist: Akashic Incursion
        if ($acid == '900637071')  {$vov6 = $vov6 + 1; $vov61 =$kdate.'<font color="808080"><strike>Grandmother Deliria</strike></font><br>';}
        if ($acid == '4215973678') {$vov6 = $vov6 + 1; $vov62 =$kdate.'<font color="808080"><strike>Mother Ballentree</strike></font><br>';}
        if ($acid == '3110830549') {$vov6 = $vov6 + 1; $vov63 =$kdate.'<font color="808080"><strike>Cloaked Necromancer</strike></font><br>';}
        if ($acid == '253358260')  {$vov6 = $vov6 + 1; $vov64 =$kdate.'<font color="808080"><strike>Sister Belladonna & Auntie Grimm</strike></font><br>';}
        if ($acid == '638828590')  {$vov6 = $vov6 + 1; $vov65 =$kdate.'<font color="808080"><strike>Odelia Wretch</strike></font><br>';}
        if ($acid == '951091466')  {$vov6 = $vov6 + 1; $vov66 =$kdate.'<font color="808080"><strike>Beulus the Claw</strike></font><br>';}
        if ($acid == '2630164791') {$vov6 = $vov6 + 1; $vov67 =$kdate.'<font color="808080"><strike>Flora Meldahyde</strike></font><br>';}
        //Fabled Veeshan's Peak
        if ($acid == '4227713287') {$fvp = $fvp + 1; $fvp1  =$kdate.'<font color="808080"><strike>Trakanon</strike></font><br>';}
        if ($acid == '3054429420') {$fvp = $fvp + 1; $fvp2  =$kdate.'<font color="808080"><strike>Phara Dar</strike></font><br>';}
        if ($acid == '2521580809') {$fvp = $fvp + 1; $fvp3  =$kdate.'<font color="808080"><strike>Silverwing</strike></font><br>';}
        if ($acid == '2410932970') {$fvp = $fvp + 1; $fvp4  =$kdate.'<font color="808080"><strike>Travenro the Skygazer</strike></font><br>';}
        if ($acid == '2288801631') {$fvp = $fvp + 1; $fvp5  =$kdate.'<font color="808080"><strike>Xygoz</strike></font><br>';}
        if ($acid == '3132681953') {$fvp = $fvp + 1; $fvp6  =$kdate.'<font color="808080"><strike>Hoshkar</strike></font><br>';}
        if ($acid == '4189700864') {$fvp = $fvp + 1; $fvp7  =$kdate.'<font color="808080"><strike>Qunard Ashenclaw</strike></font><br>';}
        if ($acid == '1302960487') {$fvp = $fvp + 1; $fvp8  =$kdate.'<font color="808080"><strike>Milyex Vioren</strike></font><br>';}
        if ($acid == '1827419504') {$fvp = $fvp + 1; $fvp9  =$kdate.'<font color="808080"><strike>Taskmaster Nichok</strike></font><br>';}
        if ($acid == '2932604263') {$fvp = $fvp + 1; $fvp10 =$kdate.'<font color="808080"><strike>Druushk</strike></font><br>';}
        if ($acid == '1313567184') {$fvp = $fvp + 1; $fvp11 =$kdate.'<font color="808080"><strike>Elder Ekron</strike></font><br>';}
        if ($acid == '3402130995') {$fvp = $fvp + 1; $fvp12 =$kdate.'<font color="808080"><strike>Nexona</strike></font><br>';}
        if ($acid == '2186735374') {$fvp = $fvp + 1; $fvp13 =$kdate.'<font color="808080"><strike>Kluzen the Protector</strike></font><br>';}
        //Fabled Kurns Tower
        if ($acid == '305511197')  {$fkt = $fkt + 1; $fkt1 =$kdate.'<font color="808080"><strike>Warlord Kurn Machta</strike></font><br>';}
        if ($acid == '254839717')  {$fkt = $fkt + 1; $fkt2 =$kdate.'<font color="808080"><strike>Sir Rouland</strike></font><br>';}
        if ($acid == '3647563960') {$fkt = $fkt + 1; $fkt3 =$kdate.'<font color="808080"><strike>Ione the Lifebringer</strike></font><br>';}
        if ($acid == '3295434752') {$fkt = $fkt + 1; $fkt4 =$kdate.'<font color="808080"><strike>Ilenee\'s Betrayal and Despair</strike></font><br>';}
        if ($acid == '2309290251') {$fkt = $fkt + 1; $fkt5 =$kdate.'<font color="808080"><strike>Haggle Baron Klok</strike></font><br>';}
        //Fabled Kurns Tower 1 Group
        if ($acid == '2397673343') {$fktg = $fktg + 1; $fktg1 =$kdate.'<font color="808080"><strike>Warlord Kurn Machta</strike></font><br>';}
        if ($acid == '1263446513') {$fktg = $fktg + 1; $fktg2 =$kdate.'<font color="808080"><strike>Sir Rouland</strike></font><br>';}
        if ($acid == '681483467')  {$fktg = $fktg + 1; $fktg3 =$kdate.'<font color="808080"><strike>Ione the Lifebringer</strike></font><br>';}
        if ($acid == '743615551')  {$fktg = $fktg + 1; $fktg4 =$kdate.'<font color="808080"><strike>Ilenee\'s Betrayal and Despair</strike></font><br>';}
        //Raj'Dur Plateaus
	if ($acid == '1131635143') {$ror1 = $ror1 + 1; $ror11 =$kdate.'<font color="808080"><strike>Raj\'Dur Foreman Yato</strike></font><br>';}
	if ($acid == '3610285632') {$ror1 = $ror1 + 1; $ror12 =$kdate.'<font color="808080"><strike>Raj\'Dur Leader Mamu</strike></font><br>';}
	if ($acid == '3409434414') {$ror1 = $ror1 + 1; $ror13 =$kdate.'<font color="808080"><strike>Avenging Desert Spirit</strike></font><br>';}
	if ($acid == '3367100588') {$ror1 = $ror1 + 1; $ror14 =$kdate.'<font color="808080"><strike>Poacher Paol</strike></font><br>';}
	if ($acid == '4276000267') {$ror1 = $ror1 + 1; $ror15 =$kdate.'<font color="808080"><strike>Sythe Rotgut</strike></font><br>';}
	if ($acid == '654859999')  {$ror1 = $ror1 + 1; $ror16 =$kdate.'<font color="808080"><strike>Slither Rattlebones</strike></font><br>';}
	//Sandstone Delta
	if ($acid == '3757301018') {$ror2 = $ror2 + 1; $ror21 =$kdate.'<font color="808080"><strike>Embodiment of Fright</strike></font><br>';}
	if ($acid == '2198942199') {$ror2 = $ror2 + 1; $ror22 =$kdate.'<font color="808080"><strike>Tsmang Blightswarm Broodmaster</strike></font><br>';}
	if ($acid == '796156504')  {$ror2 = $ror2 + 1; $ror23 =$kdate.'<font color="808080"><strike>Malformed Prophet</strike></font><br>';}
	if ($acid == '3195996785') {$ror2 = $ror2 + 1; $ror24 =$kdate.'<font color="808080"><strike>Lockmaw</strike></font><br>';}
	if ($acid == '3297080045') {$ror2 = $ror2 + 1; $ror25 =$kdate.'<font color="808080"><strike>Mad Zealot</strike></font><br>';}
	if ($acid == '2828429105') {$ror2 = $ror2 + 1; $ror26 =$kdate.'<font color="808080"><strike>Rath\'Mana High Priest</strike></font><br>';}
	//Takish badlands
	if ($acid == '3980803101') {$ror3 = $ror3 + 1; $ror31 =$kdate.'<font color="808080"><strike>Huhmuhngus Fuhngus Amuhngus</strike></font><br>';}
	if ($acid == '3582948108') {$ror3 = $ror3 + 1; $ror32 =$kdate.'<font color="808080"><strike>Desert Wildcat Matron</strike></font><br>';}
	if ($acid == '3788720845') {$ror3 = $ror3 + 1; $ror33 =$kdate.'<font color="808080"><strike>Myht-moo Migmu</strike></font><br>';}
	if ($acid == '3728709900') {$ror3 = $ror3 + 1; $ror34 =$kdate.'<font color="808080"><strike>Jellyfisher Ancient</strike></font><br>';}
	if ($acid == '2882632174') {$ror3 = $ror3 + 1; $ror35 =$kdate.'<font color="808080"><strike>Ragtag the Despoiler</strike></font><br>';}
	if ($acid == '2769499035') {$ror3 = $ror3 + 1; $ror36 =$kdate.'<font color="808080"><strike>Nirag the Boundless</strike></font><br>';}
	//Buried Takish'Hiz
	if ($acid == '667813421')  {$ror4 = $ror4 + 1; $ror41 =$kdate.'<font color="808080"><strike>Stonesong</strike></font><br>';}
	if ($acid == '4290771037') {$ror4 = $ror4 + 1; $ror42 =$kdate.'<font color="808080"><strike>Rugrat</strike></font><br>';}
	if ($acid == '1997514649') {$ror4 = $ror4 + 1; $ror43 =$kdate.'<font color="808080"><strike>Monument of Stone</strike></font><br>';}
	if ($acid == '3177913924') {$ror4 = $ror4 + 1; $ror44 =$kdate.'<font color="808080"><strike>Them Bones</strike></font><br>';}
	if ($acid == '97710551')   {$ror4 = $ror4 + 1; $ror45 =$kdate.'<font color="808080"><strike>Veagth</strike></font><br>';}
	if ($acid == '1643530049') {$ror4 = $ror4 + 1; $ror46 =$kdate.'<font color="808080"><strike>Uruk the Unbound</strike></font><br>';}
	if ($acid == '945116430')  {$ror4 = $ror4 + 1; $ror47 =$kdate.'<font color="808080"><strike>Terrene Tyrant</strike></font><br>';}
	if ($acid == '2578358852') {$ror4 = $ror4 + 1; $ror48 =$kdate.'<font color="808080"><strike>Sanum Ordast</strike></font><br>';}
	//The Sultan's
	if ($acid == '1014225711') {$ror5 = $ror5 + 1; $ror51 =$kdate.'<font color="808080"><strike>Aldys</strike></font><br>';}
	//Contested
	if ($acid == '0') {$ror6 = $ror6 + 1; $ror61 =$kdate.'<font color="808080"><strike>Titanious</strike></font><br>';}
	//Vaashkaani, Alcazar of Zimara: Chromatic Chamber
	if ($acid == '805946182')  {$boz1 = $boz1 + 1; $boz11 =$kdate.'<font color="808080"><strike>Aurous the Judged</strike></font><br>';}
	if ($acid == '983895965')  {$boz1 = $boz1 + 1; $boz12 =$kdate.'<font color="808080"><strike>Krayte, Titan of Colors</strike></font><br>';}
	if ($acid == '3945744748') {$boz1 = $boz1 + 1; $boz13 =$kdate.'<font color="808080"><strike>Chromon</strike></font><br>';}
	//Zimara Breadth: Crested Expanse
	if ($acid == '1091914971') {$boz2 = $boz2 + 1; $boz21 =$kdate.'<font color="808080"><strike>Chohnkanon</strike></font><br>';}
	if ($acid == '2437902669') {$boz2 = $boz2 + 1; $boz22 =$kdate.'<font color="808080"><strike>Chohnkasaurus</strike></font><br>';}
	if ($acid == '3485523623') {$boz2 = $boz2 + 1; $boz23 =$kdate.'<font color="808080"><strike>Chohnki</strike></font><br>';}
	//Aether Wroughtlands: The Delves
	if ($acid == '3167561400') {$boz3 = $boz3 + 1; $boz31 =$kdate.'<font color="808080"><strike>Rouk the Immeasurable</strike></font><br>';}
	if ($acid == '2396947656') {$boz3 = $boz3 + 1; $boz32 =$kdate.'<font color="808080"><strike>Rouk the Ironclad</strike></font><br>';}
	if ($acid == '2325848973') {$boz3 = $boz3 + 1; $boz33 =$kdate.'<font color="808080"><strike>Rouk the Lustrous</strike></font><br>';}
	if ($acid == '2699255177') {$boz3 = $boz3 + 1; $boz34 =$kdate.'<font color="808080"><strike>Tuer\'el of the Delves</strike></font><br>';}
	if ($acid == '937539396')  {$boz3 = $boz3 + 1; $boz35 =$kdate.'<font color="808080"><strike>Mezkhuur, Equestrian Liege</strike></font><br>';}
	//Vaashkaani, Alcazar of Zimara: Sovereign Summons
	if ($acid == '146318363')  {$boz4 = $boz4 + 1; $boz41 =$kdate.'<font color="808080"><strike>Zakir-Sar-Ussur</strike></font><br>';}
	if ($acid == '4279899483') {$boz4 = $boz4 + 1; $boz42 =$kdate.'<font color="808080"><strike>St\'Vyrn the Persecutor</strike></font><br>';}
	if ($acid == '1494281119') {$boz4 = $boz4 + 1; $boz43 =$kdate.'<font color="808080"><strike>Ikal-tam the Pensive</strike></font><br>';}
	if ($acid == '1581067278') {$boz4 = $boz4 + 1; $boz44 =$kdate.'<font color="808080"><strike>Chaltieu, Mirrored Sentry</strike></font><br>';}
	if ($acid == '2436747912') {$boz4 = $boz4 + 1; $boz45 =$kdate.'<font color="808080"><strike>Galeistria the Polished</strike></font><br>';}
	}
        //Add Flawless Tag
        for ($b=0; $b<=$ktot; $b++) {
        $acid = $achieve[$b]['id'];
        ...
        if ($acid == '1679240414') {$ros51 = $fkdate.'<font color="808080"><strike>Emperor Ssraeshza</strike></font> FLAWLESS<br>';} 
        if ($acid == '910374177')  {$ros52 = $fkdate.'<font color="808080"><strike>High Priest Verrkar</strike></font> FLAWLESS<br>';} 
        if ($acid == '1139375869') {$ros53 = $fkdate.'<font color="808080"><strike>Akhessa Va Liako Vess</strike></font> FLAWLESS<br>';} 
        if ($acid == '3489003425') {$ros54 = $fkdate.'<font color="808080"><strike>Thall Va Xakra Fer</strike></font> FLAWLESS<br>';} 
        if ($acid == '273111130')  {$ros55 = $fkdate.'<font color="808080"><strike>Thall Xundrax Diabo</strike></font> FLAWLESS<br>';} 
        if ($acid == '3803695887') {$ros56 = $fkdate.'<font color="808080"><strike>Diabo Xi Va</strike></font> FLAWLESS<br>';} 
        if ($acid == '1379074528') {$ros61 = $fkdate.'<font color="808080"><strike>Colossus of Crystallized Shadow</strike></font> FLAWLESS<br>';} 
        if ($acid == '3404888056') {$ros62 = $fkdate.'<font color="808080"><strike>Shadowcaster Grimlock</strike></font> FLAWLESS<br>';} 
        if ($acid == '3567735299') {$ros63 = $fkdate.'<font color="808080"><strike>Beast From Beyond</strike></font> FLAWLESS<br>';} 
        if ($acid == '878042125')  {$ros64 = $fkdate.'<font color="808080"><strike>Greta Gnitrat</strike></font> FLAWLESS<br>';} 
        if ($acid == '465794625')  {$ros71 = $fkdate.'<font color="808080"><strike>Emperor Ssraeshza</strike></font> FLAWLESS<br>';} 
        if ($acid == '1260676298') {$ros72 = $fkdate.'<font color="808080"><strike>High Priest Verrkar</strike></font> FLAWLESS<br>';} 
        if ($acid == '589702258')  {$ros73 = $fkdate.'<font color="808080"><strike>Akhessa Va Liako Vess</strike></font> FLAWLESS<br>';} 
        if ($acid == '2939858222') {$ros74 = $fkdate.'<font color="808080"><strike>Thall Va Xakra Fer</strike></font> FLAWLESS<br>';} 
        if ($acid == '1830816177') {$ros75 = $fkdate.'<font color="808080"><strike>Thall Xundrax Diabo</strike></font> FLAWLESS<br>';} 
        if ($acid == '4156174266') {$ros76 = $fkdate.'<font color="808080"><strike>Diabo Xi Va</strike></font> FLAWLESS<br>';} 
        //$bl11 = $fkdate.substr_replace($bl11 ,"", -4).' FLAWLESS<br>';}
        if ($acid == '3793134098') {$vov11 = $fkdate.'<font color="808080"><strike>Guardian of the Plumage</strike></font> FLAWLESS<br>';}
        if ($acid == '165285324')  {$vov12 = $fkdate.'<font color="808080"><strike>Behemothrus and Gargantaur</strike></font> FLAWLESS<br>';}
        if ($acid == '3740112396') {$vov13 = $fkdate.'<font color="808080"><strike>Vetrovian Mantrap</strike></font> FLAWLESS<br>';}
        if ($acid == '3624987382') {$vov14 = $fkdate.'<font color="808080"><strike>Glaur Xrzin</strike></font> FLAWLESS<br>';}
        if ($acid == '1827691807') {$vov15 = $fkdate.'<font color="808080"><strike>Quilliclaw</strike></font> FLAWLESS<br>';}
        if ($acid == '1294304333') {$vov21 = $fkdate.'<font color="808080"><strike>Ritual Lords</strike></font> FLAWLESS<br>';}
        if ($acid == '3436497909') {$vov22 = $fkdate.'<font color="808080"><strike>Cewtie Irewater</strike></font> FLAWLESS<br>';}
        if ($acid == '2648186843') {$vov23 = $fkdate.'<font color="808080"><strike>Persepherator</strike></font> FLAWLESS<br>';}
        if ($acid == '2580406009') {$vov24 = $fkdate.'<font color="808080"><strike>Cliff Dweller Gadsin</strike></font> FLAWLESS<br>';}
        if ($acid == '240958407')  {$vov25 = $fkdate.'<font color="808080"><strike>Cewtie Irewater</strike></font> FLAWLESS<br>';}
        if ($acid == '4175815710') {$vov31 = $fkdate.'<font color="808080"><strike>Lithania Dyrmelia</strike></font> FLAWLESS<br>';}
        if ($acid == '9960473')    {$vov32 = $fkdate.'<font color="808080"><strike>Reanimated Horror</strike></font> FLAWLESS<br>';}
        if ($acid == '2533141091') {$vov33 = $fkdate.'<font color="808080"><strike>Hand of Lithania</strike></font> FLAWLESS<br>';}
        if ($acid == '475122421')  {$vov34 = $fkdate.'<font color="808080"><strike>G\'dalt Spirit-stitcher</strike></font> FLAWLESS<br>';}
        if ($acid == '3815643403') {$vov35 = $fkdate.'<font color="808080"><strike>Envoy to Bloodrite</strike></font> FLAWLESS<br>';}
        if ($acid == '2096213814') {$vov41 = $fkdate.'<font color="808080"><strike>Vorigan Mistmoore</strike></font> FLAWLESS<br>';}
        if ($acid == '1538632475') {$vov42 = $fkdate.'<font color="808080"><strike>Lysander Mistmoore</strike></font> FLAWLESS<br>';}
        if ($acid == '3000628948') {$vov43 = $fkdate.'<font color="808080"><strike>Bloodtender and Gidget</strike></font> FLAWLESS<br>';}
        if ($acid == '1028460683') {$vov44 = $fkdate.'<font color="808080"><strike>Legion Captain Bloodrite</strike></font> FLAWLESS<br>';}
        if ($acid == '3473497666') {$vov45 = $fkdate.'<font color="808080"><strike>Lady of the Lute</strike></font> FLAWLESS<br>';}
        if ($acid == '3131490753') {$vov51 = $fkdate.'<font color="808080"><strike>Lord Mayong Mistmoore</strike></font> FLAWLESS<br>';}
        if ($acid == '374252926')  {$vov52 = $fkdate.'<font color="808080"><strike>Poppet the Thrasher</strike></font> FLAWLESS<br>';}
        if ($acid == '3609000623') {$vov53 = $fkdate.'<font color="808080"><strike>Lenya Thex</strike></font> FLAWLESS<br>';}
        if ($acid == '2021565551') {$vov54 = $fkdate.'<font color="808080"><strike>Zarrakon Resurrected</strike></font> FLAWLESS<br>';}
        if ($acid == '2974989475') {$vov55 = $fkdate.'<font color="808080"><strike>Butcher</strike></font> FLAWLESS<br>';}	
        if ($acid == '2766700754') {$vov61 = $fkdate.'<font color="808080"><strike>Grandmother Deliria</strike></font> FLAWLESS<br>';}	
        if ($acid == '2610891734') {$vov62 = $fkdate.'<font color="808080"><strike>Mother Ballentree</strike></font> FLAWLESS<br>';}	
        if ($acid == '4195820500') {$vov63 = $fkdate.'<font color="808080"><strike>Cloaked Necromancer</strike></font> FLAWLESS<br>';}	
        if ($acid == '253358260')  {$vov64 = $fkdate.'<font color="808080"><strike>Sister Belladonna & Auntie Grimm</strike></font> FLAWLESS<br>';}	
        if ($acid == '1187409110') {$vov65 = $fkdate.'<font color="808080"><strike>Odelia Wretch</strike></font> FLAWLESS<br>';}	
        if ($acid == '1001743785') {$vov66 = $fkdate.'<font color="808080"><strike>Beulus the Claw</strike></font> FLAWLESS<br>';}	
        if ($acid == '4192668840') {$vov67 = $fkdate.'<font color="808080"><strike>Flora Meldahyde</strike></font> FLAWLESS<br>';}	
        if ($acid == '2665719770') {$fvp1  = $fkdate.'<font color="808080"><strike>Trakanon</strike></font> FLAWLESS<br>';}	
        if ($acid == '1309234411') {$fvp2  = $fkdate.'<font color="808080"><strike>Phara Dar</strike></font> FLAWLESS<br>';}	
        if ($acid == '147904282')  {$fvp3  = $fkdate.'<font color="808080"><strike>Silverwing</strike></font> FLAWLESS<br>';}	
        if ($acid == '3937240119') {$fvp4  = $fkdate.'<font color="808080"><strike>Travenro the Skygazer</strike></font> FLAWLESS<br>';}	
        if ($acid == '4282742149') {$fvp5  = $fkdate.'<font color="808080"><strike>Xygoz</strike></font> FLAWLESS<br>';}	
        if ($acid == '336590265')  {$fvp6  = $fkdate.'<font color="808080"><strike>Hoshkar</strike></font> FLAWLESS<br>';}	
        if ($acid == '2680738280') {$fvp7  = $fkdate.'<font color="808080"><strike>Qunard Ashenclaw</strike></font> FLAWLESS<br>';}	
        if ($acid == '735611791')  {$fvp8  = $fkdate.'<font color="808080"><strike>Milyex Vioren</strike></font> FLAWLESS<br>';}	
        if ($acid == '4067469155') {$fvp9  = $fkdate.'<font color="808080"><strike>Taskmaster Nichok</strike></font> FLAWLESS<br>';}	
        if ($acid == '8185407')    {$fvp10 = $fkdate.'<font color="808080"><strike>Druushk</strike></font> FLAWLESS<br>';}	
        if ($acid == '962745098')  {$fvp11 = $fkdate.'<font color="808080"><strike>Elder Ekron</strike></font> FLAWLESS<br>';}	
        if ($acid == '2897835227') {$fvp12 = $fkdate.'<font color="808080"><strike>Nexona</strike></font> FLAWLESS<br>';}	
        if ($acid == '3827826150') {$fvp13 = $fkdate.'<font color="808080"><strike>Kluzen the Protector</strike></font> FLAWLESS<br>';}	
        if ($acid == '86203035')   {$fkt1  = $fkdate.'<font color="808080"><strike>Warlord Kurn Machta</strike></font> FLAWLESS<br>';}	
        if ($acid == '405170723')  {$fkt2  = $fkdate.'<font color="808080"><strike>Sir Rouland</strike></font> FLAWLESS<br>';}	
        if ($acid == '3464464702') {$fkt3  = $fkdate.'<font color="808080"><strike>Ione the Lifebringer</strike></font> FLAWLESS<br>';}	
        if ($acid == '3548035462') {$fkt4  = $fkdate.'<font color="808080"><strike>Ilenee\'s Betrayal and Despair</strike></font> FLAWLESS<br>';}	
        if ($acid == '2662471821') {$fkt5  = $fkdate.'<font color="808080"><strike>Haggle Baron Klok</strike></font> FLAWLESS<br>';}	
	if ($acid == '3841530489') {$ror11  = $fkdate.'<font color="808080"><strike>Raj\'Dur Foreman Yato</strike></font> FLAWLESS<br>';}	
	if ($acid == '980240804')  {$ror12  = $fkdate.'<font color="808080"><strike>Raj\'Dur Leader Mamu</strike></font> FLAWLESS<br>';}	
	if ($acid == '1721488466') {$ror13  = $fkdate.'<font color="808080"><strike>Avenging Desert Spirit</strike></font> FLAWLESS<br>';}	
	if ($acid == '1696457680') {$ror14  = $fkdate.'<font color="808080"><strike>Poacher Paol</strike></font> FLAWLESS<br>';}	
	if ($acid == '1400018295') {$ror15  = $fkdate.'<font color="808080"><strike>Sythe Rotgut</strike></font> FLAWLESS<br>';}	
	if ($acid == '2393797446') {$ror16  = $fkdate.'<font color="808080"><strike>Slither Rattlebones</strike></font> FLAWLESS<br>';}	
	if ($acid == '424110341')  {$ror21  = $fkdate.'<font color="808080"><strike>Embodiment of Fright</strike></font> FLAWLESS<br>';}	
	if ($acid == '2185727560') {$ror22  = $fkdate.'<font color="808080"><strike>Tsmang Blightswarm Broodmaster</strike></font> FLAWLESS<br>';}	
	if ($acid == '4286338927') {$ror23  = $fkdate.'<font color="808080"><strike>Malformed Prophet</strike></font> FLAWLESS<br>';}	
	if ($acid == '1853308742') {$ror24  = $fkdate.'<font color="808080"><strike>Lockmaw</strike></font> FLAWLESS<br>';}	
	if ($acid == '2896605704') {$ror25  = $fkdate.'<font color="808080"><strike>Mad Zealot</strike></font> FLAWLESS<br>';}	
	if ($acid == '3150226270') {$ror26  = $fkdate.'<font color="808080"><strike>Rath\'Mana High Priest</strike></font> FLAWLESS<br>';}	
	if ($acid == '1867067136') {$ror31  = $fkdate.'<font color="808080"><strike>Huhmuhngus Fuhngus Amuhngus</strike></font> FLAWLESS<br>';}	
	if ($acid == '1603746824') {$ror32  = $fkdate.'<font color="808080"><strike>Desert Wildcat Matron</strike></font> FLAWLESS<br>';}	
	if ($acid == '1808467401') {$ror33  = $fkdate.'<font color="808080"><strike>Myht-moo Migmu</strike></font> FLAWLESS<br>';}	
	if ($acid == '2783786689') {$ror34  = $fkdate.'<font color="808080"><strike>Jellyfisher Ancient</strike></font> FLAWLESS<br>';}	
	if ($acid == '3596063221') {$ror35  = $fkdate.'<font color="808080"><strike>Ragtag the Despoiler</strike></font> FLAWLESS<br>';}	
	if ($acid == '3633699712') {$ror36  = $fkdate.'<font color="808080"><strike>Nirag the Boundless</strike></font> FLAWLESS<br>';}	
	if ($acid == '414172928')  {$ror41  = $fkdate.'<font color="808080"><strike>Stonesong</strike></font> FLAWLESS<br>';}	
	if ($acid == '3809750163') {$ror42  = $fkdate.'<font color="808080"><strike>Rugrat</strike></font> FLAWLESS<br>';}	
	if ($acid == '2747815743') {$ror43  = $fkdate.'<font color="808080"><strike>Monument of Stone</strike></font> FLAWLESS<br>';}	
	if ($acid == '2181750633') {$ror44  = $fkdate.'<font color="808080"><strike>Them Bones</strike></font> FLAWLESS<br>';}	
	if ($acid == '427369753')  {$ror45  = $fkdate.'<font color="808080"><strike>Veagth</strike></font> FLAWLESS<br>';}	
	if ($acid == '2789468944') {$ror46  = $fkdate.'<font color="808080"><strike>Uruk the Unbound</strike></font> FLAWLESS<br>';}	
	if ($acid == '1150620013') {$ror47  = $fkdate.'<font color="808080"><strike>Terrene Tyrant</strike></font> FLAWLESS<br>';}	
	if ($acid == '2143636409') {$ror48  = $fkdate.'<font color="808080"><strike>Sanum Ordast</strike></font> FLAWLESS<br>';}	
	if ($acid == '3552484481') {$ror51  = $fkdate.'<font color="808080"><strike>Aldys</strike></font> FLAWLESS<br>';}	
	if ($acid == '2143636409') {$ror61  = $fkdate.'<font color="808080"><strike>Titanious</strike></font> FLAWLESS<br>';}
	if ($acid == '3022159903') {$boz11  = $fkdate.'<font color="808080"><strike>Aurous the Judged</strike></font> FLAWLESS<br>';}
	if ($acid == '158764028')  {$boz12  = $fkdate.'<font color="808080"><strike>Krayte, Titan of Colors</strike></font> FLAWLESS<br>';}
	if ($acid == '3022159903') {$boz13  = $fkdate.'<font color="808080"><strike>Chromon</strike></font> FLAWLESS<br>';}
	if ($acid == '3138897298') {$boz21  = $fkdate.'<font color="808080"><strike>Chohnkanon</strike></font> FLAWLESS<br>';}
	if ($acid == '613434503')  {$boz22  = $fkdate.'<font color="808080"><strike>Chohnkasaurus</strike></font> FLAWLESS<br>';}
	if ($acid == '2825293983') {$boz23  = $fkdate.'<font color="808080"><strike>Chohnki</strike></font> FLAWLESS<br>';}
	if ($acid == '2312053981') {$boz31  = $fkdate.'<font color="808080"><strike>Rouk the Immeasurable</strike></font> FLAWLESS<br>';}
	if ($acid == '3006468893') {$boz32  = $fkdate.'<font color="808080"><strike>Rouk the Ironclad</strike></font> FLAWLESS<br>';}
	if ($acid == '3215172072') {$boz33  = $fkdate.'<font color="808080"><strike>Rouk the Lustrous</strike></font> FLAWLESS<br>';}
	if ($acid == '3072347895') {$boz34  = $fkdate.'<font color="808080"><strike>Tuer\'el of the Delves</strike></font> FLAWLESS<br>';}
	if ($acid == '48477473')   {$boz35  = $fkdate.'<font color="808080"><strike>Mezkhuur, Equestrian Liege</strike></font> FLAWLESS<br>';}
	if ($acid == '4267153793') {$boz41  = $fkdate.'<font color="808080"><strike>Zakir-Sar-Ussur</strike></font> FLAWLESS<br>';}
	if ($acid == '752667957')  {$boz42  = $fkdate.'<font color="808080"><strike>St\'Vyrn the Persecutor</strike></font> FLAWLESS<br>';}
	if ($acid == '549398004')  {$boz43  = $fkdate.'<font color="808080"><strike>Ikal-tam the Pensive</strike></font> FLAWLESS<br>';}
	if ($acid == '2382099552') {$boz44  = $fkdate.'<font color="808080"><strike>Chaltieu, Mirrored Sentry</strike></font> FLAWLESS<br>';}
	if ($acid == '3796573569') {$boz45  = $fkdate.'<font color="808080"><strike>Galeistria the Polished</strike></font> FLAWLESS<br>';}
	}
        $killslist = array($c1,$c2,$c3,$c4,$c5,$c6,$c7,$c8,$c9,$contested,
                           ...
                           $ros41,$ros4,
                           $ros51,$ros52,$ros53,$ros54,$ros55,$ros56,$ros5,
                           $ros61,$ros62,$ros63,$ros64,$ros6,
                           $ros71,$ros72,$ros73,$ros74,$ros75,$ros76,$ros7,
                           $vov11,$vov12,$vov13,$vov14,$vov15,$vov1,
                           $vov21,$vov22,$vov23,$vov24,$vov25,$vov2,
                           $vov31,$vov32,$vov33,$vov34,$vov35,$vov3,
                           $vov41,$vov42,$vov43,$vov44,$vov45,$vov4,
                           $vov51,$vov52,$vov53,$vov54,$vov55,$vov5,
                           $vov61,$vov62,$vov63,$vov64,$vov65,$vov66,$vov67,$vov6,
                           $fvp1,$fvp2,$fvp3,$fvp4,$fvp5,$fvp6,$fvp7,$fvp8,$fvp9,$fvp10,$fvp11,$fvp12,$fvp13,$fvp,
                           $fkt1,$fkt2,$fkt3,$fkt4,$fkt5,$fkt,
                           $fktg1,$fktg2,$fktg3,$fktg4,$fktg5,$fktg,
			   $ror11,$ror12,$ror13,$ror14,$ror15,$ror16,$ror1,
			   $ror21,$ror22,$ror23,$ror24,$ror25,$ror26,$ror2,
			   $ror31,$ror32,$ror33,$ror34,$ror35,$ror36,$ror3,
			   $ror41,$ror42,$ror43,$ror44,$ror45,$ror46,$ror47,$ror48,$ror4,
			   $ror51,$ror5,
			   $ror61,$ror6,
			   $boz11,$boz12,$boz13,$boz1,
			   $boz21,$boz22,$boz23,$boz2,
			   $boz31,$boz32,$boz33,$boz34,$boz35,$boz3,
			   $boz41,$boz42,$boz43,$boz44,$boz45,$boz4
	);
        ...
        $ros5t = ($killslist[580].$killslist[581].$killslist[582].$killslist[583].$killslist[584].$killslist[585]);
        $zonetotal78 = ($killslist[586]);
        $ros6t = ($killslist[587].$killslist[588].$killslist[589].$killslist[590]);
        $zonetotal79 = ($killslist[591]);
        $ros7t = ($killslist[592].$killslist[593].$killslist[594].$killslist[595].$killslist[596].$killslist[597]);
        $zonetotal80 = ($killslist[598]);
		$vov1t = ($killslist[599].$killslist[600].$killslist[601].$killslist[602].$killslist[603]);
        $zonetotal81 = ($killslist[604]);
		$vov2t = ($killslist[605].$killslist[606].$killslist[607].$killslist[608].$killslist[609]);
        $zonetotal82 = ($killslist[610]);
		$vov3t = ($killslist[611].$killslist[612].$killslist[613].$killslist[614].$killslist[615]);
        $zonetotal83 = ($killslist[616]);
		$vov4t = ($killslist[617].$killslist[618].$killslist[619].$killslist[620].$killslist[621]);
        $zonetotal84 = ($killslist[622]);
		$vov5t = ($killslist[623].$killslist[624].$killslist[625].$killslist[626].$killslist[627]);
        $zonetotal85 = ($killslist[628]);
        $vov6t = ($killslist[629].$killslist[630].$killslist[631].$killslist[632].$killslist[633].$killslist[634].$killslist[635]);
        $zonetotal86 = ($killslist[636]);
        $fvpt = ($killslist[637].$killslist[638].$killslist[639].$killslist[640].$killslist[641].$killslist[642].$killslist[643].
                 $killslist[644].$killslist[645].$killslist[646].$killslist[647].$killslist[648].$killslist[649]);
        $zonetotal87 = ($killslist[650]);
        $fktt = ($killslist[651].$killslist[652].$killslist[653].$killslist[654].$killslist[655]);
        $zonetotal88 = ($killslist[656]);
        $fktgt = ($killslist[657].$killslist[658].$killslist[659].$killslist[660].$killslist[661]);
        $zonetotal89 = ($killslist[662]);
	$ror1t = ($killslist[663].$killslist[664].$killslist[665].$killslist[666].$killslist[667].$killslist[668]);
	$zonetotal90 = ($killslist[669]);
	$ror2t = ($killslist[670].$killslist[671].$killslist[672].$killslist[673].$killslist[674].$killslist[675]);
	$zonetotal91 = ($killslist[676]);
	$ror3t = ($killslist[677].$killslist[678].$killslist[679].$killslist[680].$killslist[681].$killslist[682]);
	$zonetotal92 = ($killslist[683]);
	$ror4t = ($killslist[684].$killslist[685].$killslist[686].$killslist[687].$killslist[688].$killslist[689].$killslist[690].$killslist[691]);
	$zonetotal93 = ($killslist[692]);
	$ror5t = ($killslist[693]);
	$zonetotal94 = ($killslist[694]);
	$ror6t = ($killslist[695]);
	$zonetotal95 = ($killslist[696]);
	$boz1t = ($killslist[697].$killslist[698].$killslist[699]);
	$zonetotal96 = ($killslist[700]);
	$boz2t = ($killslist[701].$killslist[702].$killslist[703]);
	$zonetotal97 = ($killslist[704]);
	$boz3t = ($killslist[705].$killslist[706].$killslist[707].$killslist[708].$killslist[709]);
	$zonetotal98 = ($killslist[710]);
	$boz4t = ($killslist[711].$killslist[712].$killslist[713].$killslist[714].$killslist[715]);
	$zonetotal99 = ($killslist[716]);
	$zonename1 = $cval;           $zonemax1 = $contmax;        $zonetip1 = $contes;
        ...
        $zonename78 = $ros5val;       $zonemax78 = $ros5max;       $zonetip78 = $ros5t;
        $zonename79 = $ros6val;       $zonemax79 = $ros6max;       $zonetip79 = $ros6t;
        $zonename80 = $ros7val;       $zonemax80 = $ros7max;       $zonetip80 = $ros7t;
        $zonename81 = $vov1val;       $zonemax81 = $vov1max;       $zonetip81 = $vov1t;
        $zonename82 = $vov2val;       $zonemax82 = $vov2max;       $zonetip82 = $vov2t;
        $zonename83 = $vov3val;       $zonemax83 = $vov3max;       $zonetip83 = $vov3t;
        $zonename84 = $vov4val;       $zonemax84 = $vov4max;       $zonetip84 = $vov4t;
        $zonename85 = $vov5val;       $zonemax85 = $vov5max;       $zonetip85 = $vov5t;
        $zonename86 = $vov6val;       $zonemax86 = $vov6max;       $zonetip86 = $vov6t;        
        $zonename87 = $fvpval;        $zonemax87 = $fvpmax;        $zonetip87 = $fvpt;
        $zonename88 = $fktval;        $zonemax88 = $fktmax;        $zonetip88 = $fktt;
        $zonename89 = $fktgval;       $zonemax89 = $fktgmax;       $zonetip89 = $fktgt;
	$zonename90 = $ror1val;       $zonemax90 = $ror1max;       $zonetip90 = $ror1t;
	$zonename91 = $ror2val;       $zonemax91 = $ror2max;       $zonetip91 = $ror2t;
	$zonename92 = $ror3val;       $zonemax92 = $ror3max;       $zonetip92 = $ror3t;
	$zonename93 = $ror4val;       $zonemax93 = $ror4max;       $zonetip93 = $ror4t;
	$zonename94 = $ror5val;       $zonemax94 = $ror5max;       $zonetip94 = $ror5t;
	$zonename95 = $ror6val;       $zonemax95 = $ror6max;       $zonetip95 = $ror6t;
	$zonename96 = $boz1val;       $zonemax96 = $boz1max;       $zonetip96 = $boz1t;
	$zonename97 = $boz2val;       $zonemax97 = $boz2max;       $zonetip97 = $boz2t;
	$zonename98 = $boz3val;       $zonemax98 = $boz3max;       $zonetip98 = $boz3t;
	$zonename99 = $boz4val;       $zonemax99 = $boz4max;       $zonetip99 = $boz4t;
	$out = '';
        for($i=1;$i<=99;$i++) {
        $check = ${"zone".$i};
        if ($check == TRUE) {
